 ...
 *
 * @class   YITH_WCCOS_ICON
 * @package Yithemes
 * @since   1.0.0
 * @author  Your Inspiration Themes
 *
 */
if ( ! class_exists( 'YITH_WCCOS_ICON' ) ) {
    ...
    class YITH_WCCOS_ICON {
        ...
        public function __construct() {
            ...
            $this->_icon_font_folder_url  = YITH_WCCOS_ASSETS_URL . '/fonts';
            $this->_icon_font_folder_path = YITH_WCCOS_ASSETS_PATH . '/fonts';

            if ( !empty( $this->_icon ) ) {

                if( is_admin() ){
                    add_action( 'admin_enqueue_scripts', array( $this, 'enqueue_styles' ),999 );
                    add_action( 'yit_lightbox_style', array( $this, 'enqueue_styles' ),999 );
                } else {
        ...
        public function enqueue_styles(){
            ...
            if ( ! class_exists( 'YIT_Asset' ) ){
                ...
                wp_enqueue_style( $css_prefix . 'font-awesome', YITH_WCCOS_ASSETS_URL . '/css/font-awesome.min.css' );
         ...
         * @author   Emanuela Castorina <emanuela.castorina@yithemes.com>
         */
        public function icon_list_hook( $icon_list ){
         ...
         * @author   Emanuela Castorina <emanuela.castorina@yithemes.com>
         */
        public function get_icon_data( $icon ){
            ...
            if ( $icon != '' ) {
                ...
                $icon_data = 'data-font="' . esc_attr($ic[0]) . '" data-name="'. esc_attr($icon_code) .'" data-key="' . esc_attr($ic[1]) . '" data-yicon="' . $icon_code . '"';
            }
         ...
         * @author   Emanuela Castorina <emanuela.castorina@yithemes.com>
         */
        public function get_icon_data_array( $icon ){
     ...
     * @author   Emanuela Castorina <emanuela.castorina@yithemes.com>
     */
    function YITH_WCCOS_ICON() {
        return YITH_WCCOS_ICON::get_instance();
    }
