jQuery( function ( $ ) {
    ...
    $( '#yith-wcbep-my-page-wrapper' ).on( 'click', function () {
        custom_input_hide( true );
    ...
    save_btn.on( 'click', function () {
        ...
        if ( modified_rows.length > 0 ) {
            ...
            for ( var i in matrix_modify ) {
                var post_data = {
                    matrix_keys  : current_matrix_keys,
                    matrix_modify: [ matrix_modify[ i ] ],
                    edited_matrix: [ current_edited_matrix[ i ] ],
