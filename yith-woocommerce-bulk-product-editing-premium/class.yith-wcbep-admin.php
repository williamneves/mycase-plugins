    ...
    class YITH_WCBEP_Admin {
        ...
        public function register_panel() {
            ...
            $admin_tabs_free = array(
                ...
                //'premium'       => __( 'Premium Version', 'yith-woocommerce-bulk-product-editing' )
            );
        ...
        public function admin_enqueue_scripts() {
            ...
            $suffix = defined( 'YITH_WCBEP_PREMIUM' ) ? $suffix : '';
            ...
            if ( $is_panel ) {
                ...
                wp_enqueue_script( 'yith_wcbep_main_tab_js', YITH_WCBEP_ASSETS_URL . '/js/' . $main_tab_js, array( 'jquery', 'jquery-ui-resizable' ), '1.0.0', true );
