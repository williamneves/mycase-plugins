    ...
    class YITH_WCBEP_Exporter {
        ...
        public function render_post( $post, $prod ) {
            ...
            <item>
                ...
                <?php if ( $prod ) : ?>
                    <wp:prod_type><?php echo $prod->product_type; ?></wp:prod_type>
                <?php endif; ?>
                ...
                <channel>
                    ...
                    if ( $ids ) {
                        foreach ( $ids as $id ) {
                            ...
                            $image_gallery = $prod->get_gallery_attachment_ids();
                            ...
                            if ( !$post || !$prod || $prod->product_type == 'variation' )
                                continue;

                            $this->render_post( $post, $prod );

                            if ( $prod->product_type == 'variable' && $prod->has_child() ) {
