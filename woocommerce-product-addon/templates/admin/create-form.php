...
<div id="nmpersonalizedproduct-form-generator">
	<ul>
		...
		<li><a href="#formbox-3"><?php _e('=- Discount Coupon -=', 'nm-personalizedproduct')?></a></li>
	...
	<div id="formbox-3">
		...
		<h4>Coupon Code: PPOM25</h4>
		
		<h3>SUPER Discount</h3>
		You can get 50% Discount for our PRO plugin. Just Rate our plugin 5 stars on 
		<a href="https://wordpress.org/support/view/plugin-reviews/woocommerce-product-addon">Wordpress</a> and share your username
		with sales@najeebmedia.com to get Coupon Code.
