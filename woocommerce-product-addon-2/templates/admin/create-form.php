...
if (isset ( $_REQUEST ['productmeta_id'] ) && $_REQUEST ['do_meta'] == 'edit') {
	...
	$enable_ajax_validation = $single_productmeta -> productmeta_validation;
    $dynamic_price_hide  	= $single_productmeta -> dynamic_price_display;
	$show_cart_thumb		= $single_productmeta -> show_cart_thumb;
...
$url_cancel = add_query_arg(array('action'=>'','productmeta_id'=>''));
...
<div id="nmpersonalizedproduct-form-generator">
	<ul>
		...
		<li><a href="#formbox-3"><?php _e('PRO Features', 'nm-personalizedproduct')?></a></li>
		<li><a href="#formbox-4"><?php _e('WooCommerce Plugins', 'nm-personalizedproduct')?></a></li>
	...
	<div id="formbox-1">
		...
		<table id="form-main-settings" border="0" bordercolor=""
			...
			<tr>
				<td class="headings"><?php _e('Enable ajax based validation? [Experimental]', 'nm-personalizedproduct')?></td>
	...
	<div id="formbox-3">
		...
		<a href="http://najeebmedia.com/wordpress-plugin/woocommerce-personalized-product-option/" class="btn btn-primary">All detail</a>
	</div>
	...
	<div id="formbox-4">
		...
		<h2 class="post-header"><a href="http://najeebmedia.com/wordpress-plugin/woocommerce-checkout-field-editor-plugin/">WooCommerce Checkout Field Editor Plugin</a></h2>
		<p>Woocommerce Checkout Field Editor plugin allow site admin to edit, add and remove Checkout’s fields. It is divided into three sections like Billing, Shipping and Order.</p>
		...
		<h2><a href="http://najeebmedia.com/wordpress-plugin/woocommerce-customizer/">WooCommerce Customizer</a></h2>
...
<h2><a href="http://najeebmedia.com/wordpress-plugin/woocommerce-product-designer/">WooCommerce Product Designer</a></h2>
