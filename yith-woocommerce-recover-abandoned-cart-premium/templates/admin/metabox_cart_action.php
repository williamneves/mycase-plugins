    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="ywrac_email_status">
                ...
                <p><?php echo '<input type="button" id="sendemail" class="ywrac_send_email button action"  value="' . __( 'Send email', 'yith-woocommerce-recover-abandoned-cart' ) . '" data-id="'.$cart_id.'">' ?></p>
            </td>
        </tr>
